...
# TODO 1: list comprehension to create a list of all the full_names in lowercase format
lowercase_full_names = [name.lower() for name in full_names]
print(lowercase_full_names)

almost_numbers = ['0', '10', '21', '3', '-7', '88', '9']

#  TODO 2: list comprehension to create a list of integers from the above list of strings
numbers = [int(num) for num in almost_numbers]
print(numbers)

# TODO 3: list comprehension to create a list of only the numbers greater than 9
numbers_over_nine = [num for num in numbers if num > 9]
print(numbers_over_nine)

# TODO 4: use a list comprehension and join to create a string of last names
